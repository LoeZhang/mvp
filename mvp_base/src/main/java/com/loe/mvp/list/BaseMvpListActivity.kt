...
abstract class BaseMvpListActivity<PRESENTER : BaseModelPresenter<MODEL>, MODEL: BaseModel, BEAN> : BaseMvpActivity<PRESENTER, MODEL>()
{
    ...
    {
        override fun loadData(isRefresh: Boolean) = this@BaseMvpListActivity.loadData(isRefresh)

        override fun getListAdapter() = this@BaseMvpListActivity.getListAdapter()
    }
