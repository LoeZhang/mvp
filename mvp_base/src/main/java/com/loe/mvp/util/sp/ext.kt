 ...
 */
inline fun string(defaultValue: String = "") = object : ReadWriteProperty<Any?, String>
{
...
inline fun int(defaultValue: Int = 0) = object : ReadWriteProperty<Any?, Int>
{
...
inline fun long(defaultValue: Long = 0L) = object : ReadWriteProperty<Any?, Long>
{
...
inline fun float(defaultValue: Float = 0.0f) = object : ReadWriteProperty<Any?, Float>
{
...
inline fun double(defaultValue: Double = 0.0) = object : ReadWriteProperty<Any?, Double>
{
...
inline fun boolean(defaultValue: Boolean = false) = object : ReadWriteProperty<Any?, Boolean>
{
